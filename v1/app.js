...
const autopromise = require('./controllers/automatic/module.automatic.js');
...
// New API
app.use('/api/v1/automatic', require('./routes/automatic'));
app.use('/api/v1/smartcrash', require('./routes/smartcrash'));
